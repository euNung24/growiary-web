...
import { createPost, updatePost } from '@/user/features/post/apis/postApi';
import { ReqPostType, ResPostType } from '@/user/features/post/types/post';
...
import { PostState } from '@/user/features/post/store';
