...
import { createPost, updatePost } from '@/domain/post/api';
import { ReqPostType, ResPostType } from '@/domain/post/types';
...
import FormFooter from '@/domain/post/components/FormFooter';
import FormContent from '@/domain/post/components/FormContent';
import FormOptions from '@/domain/post/components/FormOptions';
import { PostState } from '@/domain/post/store';
